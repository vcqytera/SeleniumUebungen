...
public class FindByCSSSelectorUebung {
	...
	public void findByNameUsingCSS() {
		...
		assertEquals("expected a different id", "ul1",
	...
	public void findByIdUsingCSS() {
		...
		assertEquals("expected a match on id", "pName31",
	...
	public void findByClassNameUsingCSS() {
		...
		assertEquals("expected a different id", "div1",
				element.getAttribute("id"));
	}
	...
	public void findByTagNameUsingCSS() {
		...
		assertEquals("expected a different name", "liName1",
				element.getAttribute("name"));

	}

	@AfterClass
	public static void schliesseBrowser() {
		driver.quit();
	}
}
